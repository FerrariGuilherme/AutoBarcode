...
class LoginView:
    ...
    def view(self,page:ft.page,params:Params,basket:Basket):
        ...
        def verificaVersao():
            bd.consultar_database("SELECT * FROM versionamento WHERE atual = 'True'")
                    ...
                    controls=[
                        ...
                        ft.Column(
                            ...
                            controls=[
                                ...
                                ft.Text(value=f"Versão {VERSAO} - Fiscal  ©", italic=True, selectable=False, style='displaySmall', size=12, weight=ft.FontWeight.W_600, color="#777777"),
                                ft.Text(value=f"{verificaVersao()}", italic=True, selectable=False, style='displaySmall', size=12, weight=ft.FontWeight.W_600, color="#777777"),
                            ],
                        ),
                    ]
                )
