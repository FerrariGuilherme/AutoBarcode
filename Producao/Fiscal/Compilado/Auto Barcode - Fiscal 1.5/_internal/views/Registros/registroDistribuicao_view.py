...
"""
        ...
        txtfield_data = ft.TextField(label="Data de Saída", width=186, prefix_icon=ft.icons.CALENDAR_MONTH_OUTLINED, hint_text="DD/MM/AAAA", prefix_text="  ", height=50, border_width=0.8, border_color=ft.colors.BLACK)
