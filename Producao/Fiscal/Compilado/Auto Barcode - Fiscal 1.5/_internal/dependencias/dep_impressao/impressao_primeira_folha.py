...
def criar_pdf_primeira_folha(nome_arquivo, origem, destino, comarca, remessa, data_emissao, total, processos):
    ...
    #Define x e y Inicial
    x_inicial = 40
    y_inicial = altura - 150
    
    # ADICIONA A PRIMEIRA COLUNA DO CABEÇALHO
    ...
    # ADICIONA A SEGUNDA COLUNA DO CABEÇALHO
