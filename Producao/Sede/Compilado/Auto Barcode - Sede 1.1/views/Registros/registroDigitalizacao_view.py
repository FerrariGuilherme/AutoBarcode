        ...
        def salvarRemessa(e):
            ...
            def registra_bd(e):
                ...
                for processo in listagem_processos:
                    ...
                    bd.alterar_database(f"INSERT INTO 'processos.registro' (processo, registro, data, remessa, providencia, situacao, responsavel, observacao) VALUES ('{processo[0]}', 'DIGITALIZACAO', '{txtfield_data.value}', '{txtfield_remessa.value}', '{processo[3]}', '{processo[4]}', '{usuario[0][1]}', '')")
...
"""
        ...
        def imprimir(e):
            ...
            criar_pdf(nome_arquivo=f"\\\\10.16.100.201\\Servidor_SCR\\Novo_AutoBarcode\\pdf\\RD_{txtfield_remessa.value}_{comarca}.pdf", 
            ...
            filename = f"\\\\10.16.100.201\\Servidor_SCR\\Novo_AutoBarcode\\pdf\\RD_{txtfield_remessa.value}_{comarca}.pdf"
