...
"""
        ...
        def imprimir(e):
            ...
            criar_pdf(nome_arquivo=f"\\\\10.16.100.201\\Servidor_SCR\\Novo_AutoBarcode\\pdf\\RS_{txtfield_remessa.value}_{comarca}.pdf", 
            ...
            filename = f"\\\\10.16.100.201\\Servidor_SCR\\Novo_AutoBarcode\\pdf\\RS_{txtfield_remessa.value}_{comarca}.pdf"
