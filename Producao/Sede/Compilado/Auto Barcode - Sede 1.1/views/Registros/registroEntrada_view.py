...
"""
        ...
        def imprimir(e):
            ...
            criar_pdf(nome_arquivo=f"\\\\10.16.100.201\\Servidor_SCR\\Novo_AutoBarcode\\pdf\\RE_{txtfield_remessa.value}_{comarca}.pdf", 
            ...
            sleep(2)
            filename = f"\\\\10.16.100.201\\Servidor_SCR\\Novo_AutoBarcode\\pdf\\RE_{txtfield_remessa.value}_{comarca}.pdf"
