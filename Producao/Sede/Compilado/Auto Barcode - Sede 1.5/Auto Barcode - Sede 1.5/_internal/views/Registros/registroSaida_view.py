    ...
    def view(self,page:ft.page,params:Params,basket:Basket):
        ...
        def salvarRemessa(e):
            ...
            def registra_bd(e):
                ...
                bd.alterar_database(f'UPDATE "processos.remessa" SET processos = "{listagem_processos}" WHERE remessa = "{txtfield_remessa.value}" AND tipo = "SAIDA" and comarca = "{comarca}"')
                ...
                for processo in listagem_processos:
                    ...
                    bd.alterar_database(f"INSERT INTO 'processos.registro' (processo, registro, data, remessa, providencia, situacao, responsavel, observacao, comarca) VALUES ('{processo[0]}', 'SAIDA', '{txtfield_data.value}', '{txtfield_remessa.value}', '{processo[3]}', '{processo[4]}', '{usuario[0][1]}', '', '{comarca}')")
